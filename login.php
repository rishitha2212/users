...
// Jump to secured page
    if($_SESSION['role_id'] == 1 ){
        header("Location: http://localhost/project/table.php",true,301);
    ...
    elseif ($_SESSION['role_id'] == 2 ) {
        header("Location: http://localhost/project/orders.php", true, 301);
    }             
    elseif ($_SESSION['role_id'] == 3 ) {
        header("Location: http://localhost/project/invoice.php", true, 301);
    }  
    elseif ($_SESSION['role_id'] == 4 ) {
        header("Location: http://localhost/project/shipment.php", true, 301);
    }  
    else{
         echo "error!!!";
    }
